				...
				<div class="courses">
					...
					@foreach($courses as $course)
						...
						<div class="col-sm-3">
							<div class="course">
								@if($course->photo)
								<a href="/courses/{{$course->slug}}"><img src="http://localhost:8000/school/public/images/{{ $course->photo->filename }}"></a>
								@else
								<a href="/courses/{{$course->slug}}"><img src="http://localhost:8000/school/public/images/default.jpg"></a>
								@endif
