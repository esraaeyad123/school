					...
					<div class="user-info">
						...
						<div class="user-image">
							...
							<div id="uploaded_image">
								@if($user->photo)
								<img class="img-fluid img-thumbnail" src="http://localhost:8000/school/public/images/{{$user->photo->filename}}">
								@else
								<img class="img-fluid img-thumbnail" src="http://localhost:8000/school/public/images/default.jpg">
								@endif
							</div>
						...
						<div class="user-data">
							...
							<ul class="list-unstyled">
								...
								<li>Member_at: <sapn style="margin-left: 20px;">{{ $user->created_at->diffForHumans() }}</sapn></li>
