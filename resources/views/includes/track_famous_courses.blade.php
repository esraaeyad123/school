	...
	<div class="famous-courses">
		...
		<div class="row">
			...
			<div class="col-sm-3">
				<div class="course">
					@if($course->photo)
					<a href="http://localhost:8000/school/public/courses/{{$course->slug}}"><img src="http://localhost:8000/school/public/images/{{ $course->photo->filename }}"></a>
					@else
					<a href="http://localhost:8000/school/public/courses/{{$course->slug}}"><img src="http://localhost:8000/school/public/images/default.jpg"></a>
					@endif
					<h6><a href="http://localhost:8000/school/public/courses/{{$course->slug}}">{{\Str::limit($course->title, 50)}}</a></h6>
							...
							<div class="row">
								<div class="col-sm-2">
									<div class="course-image">
										@if($course->photo)
										<img src="http://localhost:8000/school/public/images/{{ $course->photo->filename }}">
										@else
										<img src="http://localhost:8000/school/public/images/default.jpg">
										@endif
									</div>
								</div>
								<div class="col-sm">
